...
<html>
	<head>
		<meta charset = "utf-8"/>
		<title>Hawk Heap - Login Page</title>
	...
	<body>
		...
		<!-- Create a form that takes a username and password. If the requirements are met, then the  
			user will be granted access to the main_search.php page. -->
		<div id = "bodyBoxDesign" class = "centerContents">
			<img class = "imgResize" src = "web_images/login_form.png" alt = "Signup Title"/>

			<form action = "login_verification.php" method = "post" autocomplete = "off">
				...
				<div style = "margin-top: 1vw">
					<button class = "submitButton" type = "submit" name = "submit_login">
