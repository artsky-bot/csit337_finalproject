...
<html>
	...
	<body>
		...
		creating a question and dynamically displays their question with the course number. -->
		<div id = "bodyBoxDesign" class = "centerContents">
			<div>
				<p class = "bodyParagraph" style = "font-size: 1.5vw; font-size: 1.5vh;">
				Congradulations! your question <span style = "color: red"><?php echo $courseNumber .': '. $question;?></span> has been successfully published to Hawk Heap!
				Please click on the return button to return back to the main page!</p>
			</div>
			<!-- Hit the return button to return to the main page of the website. -->
